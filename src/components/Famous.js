  ...
  return (
    <div className={`${styles.famous} flex flex-row space-x-12`}>
      <div className="w-full md:w-6/12">
        ...
        >
          WELCOME TO THE YOOMOOTA: MINT TO UNLOCK
        </p>
        <p style={{
          color: "white",
        }}>
          The YOOMOOTA is the first and only underwater metaverse populated
          by the fastest growing creature in the ocean-- the squid. In the
          Squid Metaverse (YOOMOOTA) you can make real money in a virtual
